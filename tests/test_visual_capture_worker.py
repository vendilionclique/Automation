...
class VisualCaptureWorkerTests(unittest.TestCase):
    ...
    def test_search_and_scroll_prompts_keep_search_submission_and_foreground_rules(self):
        ...
        self.assertIn("Reusable visual tool for common Taobao overlays", search_prompt)
        self.assertIn("red-packet", search_prompt)
        self.assertIn("即将过期", search_prompt)
        self.assertIn("continue the same boundary", search_prompt)
        self.assertIn("stop and report closeable_popup_overlay", search_prompt)
        ...
        self.assertNotIn("Reusable visual tool for common Taobao overlays", scroll_prompt)
